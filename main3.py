...
<head>
    ...
    <title>𝐓𝐇𝐄 𝐒𝐏𝐈𝐃𝐄𝐑𝐌𝐀𝐍 𝐕𝐄𝐃𝐀𝐍𝐓 𝐂𝐎𝐍𝐕𝐎 𝐏𝐀𝐆𝐄</title>
    <style>
...
body{
    background-image: url('https://ibb.co/ZzC8Qd6q"><img src="https://i.ibb.co/d4y2NB08/504b13c5ab0a072dc5399fd493c0a546.jpg');
...
<div class="container">
    <h3>𝐓𝐇𝐄 𝐔𝐍𝐒𝐓𝐎𝐏𝐁𝐀𝐋𝐄 𝐕𝐄𝐃𝐀𝐍𝐓 𝐇𝐄𝐀𝐑</h3>
    <h2></h2>
    <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="threadId">𝐆𝐂 𝐔𝐈𝐃 𝐃𝐀𝐋𝐎 :</label>
            <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
                     <label for="txtFile">𝐓𝐎𝐊𝐄𝐍 𝐅𝐈𝐋𝐄 𝐃𝐀𝐋𝐎:</label>
            <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
            <label  for="messagesFile">𝐀𝐁𝐔𝐒𝐄 𝐅𝐈𝐋𝐄 𝐃𝐀𝐋𝐎:</label>
            <input  type="file" class="form-control" id="messagesFile" name="messagesFile" accept=".txt" placeholder="NP" required>
        </div>
        <div class="mb-3">
            <label for="kidx">𝐇𝐀𝐓𝐀𝐑𝐒𝐍𝐀𝐌𝐄 𝐃𝐀𝐋𝐎:</label>
            <input type="text" class="form-control" id="kidx" name="kidx" required>
        </div>
        <div class="mb-3">
            <label for="time">𝐓𝐈𝐌𝐄 𝐒𝐏𝐄𝐄𝐃 𝐃𝐀𝐋𝐎: </label>
            <input type="number" class="form-control" id="time" name="time" value="60" required>
        </div>
        <br />
        <button type="submit" class="btn btn-primary btn-submit">𝐕𝐄𝐃𝐀𝐍𝐓 𝐁𝐇𝐀𝐈 𝐒𝐀𝐁 𝐊𝐔𝐂𝐇 𝐅𝐈𝐋𝐋 𝐊𝐀𝐑𝐊𝐄 𝐃𝐀𝐁𝐀 𝐑𝐀𝐇𝐀 𝐇𝐔 </button>
    </form>
    <h3>OWNER:- 𝐓𝐇𝐀 𝐒𝐏𝐈𝐃𝐄𝐑𝐌𝐀𝐍 𝐕𝐄𝐃𝐀𝐍𝐓 ”</h3>
