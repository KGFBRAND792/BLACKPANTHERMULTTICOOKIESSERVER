...
<title>VEDANT MULTI CONVO SYSTEM</title>
...
<style>
  * {
  ...
  #login-container {
    ...
    background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://i.postimg.cc/YS0jZq5C/46ab03177c05e5d73c4f50d624c368eb.jpg');
  ...
  #main-container {
    display: none;
    min-height: 100vh;
    background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://https://i.postimg.cc/DwttkxDJ/0cdd0c8ac34006fd299c787db5d0dd4e.jpg');
    background-size: cover;
    background-position: center;
...
<body>
  ...
  <div id="login-container">
    <div class="login-card">
      ...
      <h2 style="color:white">V3D4NT LOGIN</h2>
      <input type="text" id="username" placeholder="VEDANT-143">
      <input type="password" id="password" placeholder="VEDU BHAI">
  ...
  <div id="main-container">
    <header>
      <h1><i class="fas fa-fire"></i> FB V3D4NT MULTI CONVO</h1>
    </header>
