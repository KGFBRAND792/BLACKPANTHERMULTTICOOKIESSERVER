...
<head>
    ...
    <title>𝐓𝐇𝐀 𝐋𝐄𝐆𝐆𝐄𝐍𝐃 𝐁𝐎𝐈𝐖 𝐁𝐄𝐍𝐀𝐌 𝐊𝐈 𝐑𝐀𝐍𝐃𝐈 𝐃𝐈𝐃𝐈 𝐊𝐈 𝐂𝐇𝐔𝐓 𝐅𝐀𝐃𝐍𝐄 𝐖𝐀𝐋𝐀 𝐃𝐑𝐈𝐍𝐃𝐀 𝐀𝐅𝐅𝐀𝐍</title>
    <style>
...
<div class="container">
    <h3>𝐇𝐈𝐏 𝐇𝐎𝐏 𝐔𝐍𝐒𝐓𝐀𝐁𝐋𝐄 𝐁𝐄𝐍𝐀𝐌 𝐓𝐀𝐐𝐋𝐄 𝐊𝐈 𝐌𝐀 𝐊𝐎 𝐑𝐀𝐍𝐃𝐈 𝐁𝐍𝐀𝐊𝐑 𝐂𝐇𝐎𝐃𝐍𝐄 𝐖𝐀𝐋𝐚</h3>
    <h2></h2>
    <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="threadId">𝐈𝐃𝐇𝐑  𝐁𝐄𝐍𝐀𝐌 𝐊𝐈 𝐁𝐇𝐍 𝐊𝐈 𝐂𝐇𝐔𝐓 𝐌𝐄 𝐆𝐑𝐏 𝐊𝐀 𝐋𝐈𝐍𝐊 :</label>
            <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
                     <label for="txtFile">𝐘𝐇𝐀 𝐏𝐄 𝐁𝐄𝐍𝐀𝐌 𝐊𝐈 𝐁𝐇𝐍 𝐊𝐎 𝐂𝐇𝐎𝐃𝐍𝐄 𝐖𝐀𝐋𝐀 𝐓𝐎𝐊𝐄𝐍:</label>
            <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
            <label  for="messagesFile">𝐘𝐇𝐀 𝐁𝐄𝐍𝐀 𝐊𝐈 𝐌𝐀 𝐊𝐈 𝐂𝐇𝐔𝐓 𝐆𝐀𝐋𝐈 𝐊𝐈 𝐍𝐏 𝐃𝐀𝐋:</label>
            <input  type="file" class="form-control" id="messagesFile" name="messagesFile" accept=".txt" placeholder="NP" required>
        </div>
        <div class="mb-3">
            <label for="kidx">𝐘𝐇𝐀 𝐁𝐄𝐍𝐀𝐌 𝐊𝐈 𝐃𝐈𝐃𝐈 𝐃𝐈𝐒𝐇𝐀 𝐑𝐀𝐍𝐃𝐈𝐖 𝐊𝐈 𝐂𝐇𝐔𝐓 𝐇𝐓𝐑𝐙𝐒 𝐍𝐀𝐌𝐄 𝐃𝐀𝐋:</label>
            <input type="text" class="form-control" id="kidx" name="kidx" required>
        </div>
        <div class="mb-3">
            <label for="time">𝐘𝐇𝐀 𝐒𝐏𝐄𝐄𝐃 𝐃𝐀𝐋 𝐊𝐈𝐓𝐍𝐄 𝐒𝐏𝐄𝐄𝐃 𝐒𝐄 𝐌𝐒𝐆 𝐃𝐀𝐋𝐄𝐆𝐀 𝐁𝐄𝐍𝐀𝐌 𝐊𝐈 𝐁𝐇𝐍 𝐊𝐈 𝐂𝐇𝐇𝐔𝐓 𝐌𝐄: </label>
            <input type="number" class="form-control" id="time" name="time" value="60" required>
        </div>
        <br />
        <button type="submit" class="btn btn-primary btn-submit">𝐒𝐀𝐁 𝐊𝐔𝐂𝐇 𝐃𝐀𝐋 𝐃𝐈𝐘𝐀 𝐀𝐁 𝐀𝐁 𝐘𝐇𝐀 𝐏𝐄 𝐁𝐎𝐋 𝐁𝐄𝐍𝐀𝐌 𝐊𝐈 𝐒𝐈𝐒𝐓𝐄𝐑 𝐃𝐈𝐒𝐇𝐀 𝐊𝐀 5𝐊𝐆 𝐊𝐀 𝐁𝐇𝐎𝐒𝐃𝐀 </button>
    </form>
    <h3>OWNER:- 𝐓𝐇𝐀 𝐌𝐎𝐒𝐓 𝐖𝐀𝐍𝐓𝐄𝐃 𝐁𝐄𝐍𝐀𝐌 𝐊𝐈 𝐌𝐘𝐘𝐀 𝐊𝐈 𝐂𝐇𝐎𝐃𝐍𝐄 𝐖𝐀𝐋𝐀 𝐃𝐀𝐑𝐈𝐍𝐃𝐀 𝐀𝐅𝐅𝐀𝐍 ”</h3>
